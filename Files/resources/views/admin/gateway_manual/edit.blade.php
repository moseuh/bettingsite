    ...
    <div class="row">
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                ...
                <form action="{{route('admin.deposit.manual.update', [$method->method_code])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <div class="input-group has_append">
                                                ...
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><span class="currency_symbol">{{@$method->currency}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="min_amount"
                                                           placeholder="0" value="{{ getAmount($method->min_amount)}}"/>
                                                </div>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0"
                                                           name="max_amount" value="{{getAmount($method->max_amount)}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input name="field_name[]" class="form-control" type="text" value="{{$v->field_level}}" required placeholder="Field Name">
