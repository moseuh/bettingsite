...
<head>
    ...
    <!-- bootstrap css -->
    <link rel="stylesheet" href="{{asset('public/templates/css/bootstrap.min.css')}}">
    @yield('load-css')
    <!-- flaticon css -->
    <link rel="stylesheet" href="{{asset('public/templates/css/flaticon.css')}}">
    <!-- fontawesome css -->
    <link rel="stylesheet" href="{{asset('public/templates/css/fontawesome.min.css')}}">
    <!-- owl carousel css -->
    <link rel="stylesheet" href="{{asset('public/templates/css/owl.carousel.min.css')}}">
    <!-- owl carousel theme css -->
    <link rel="stylesheet" href="{{asset('public/templates/css/owl.theme.default.min.css')}}">
    <!-- slicknav css -->
    <link rel="stylesheet" href="{{asset('public/templates/css/slicknav.css')}}">
    <!-- main css -->
    <link rel="stylesheet" href="{{asset('public/templates/css/style.css')}}">
...
<!-- popper js -->
<script src="{{asset('public/templates/js/popper.min.js')}}"></script>
<!-- bootstrap js -->
<script src="{{asset('public/templates/js/bootstrap.min.js')}}"></script>
<script src="{{asset('public/admin/js/bootstrap-notify/bootstrap-notify.min.js')}}"></script>

@yield('load-js')
<!-- owl carousel js -->
<script src="{{asset('public/templates/js/owl.carousel.min.js')}}"></script>
<!-- waypoints js -->
<script src="{{asset('public/templates/js/waypoints.min.js')}}"></script>
<!-- counterup js -->
<script src="{{asset('public/templates/js/jquery.counterup.min.js')}}"></script>
<!-- slicknav js -->
<script src="{{asset('public/templates/js/jquery.slicknav.min.js')}}"></script>
<!-- main js -->
<script src="{{asset('public/templates/js/main.js')}}"></script>
